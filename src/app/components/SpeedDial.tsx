...
const SpeedDial = () => {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      >
        <div
          className="relative flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-blue-400 to-blue-600
          transition-transform duration-200 group-hover:rotate-12 shadow-lg shadow-blue-500/30"
        >
